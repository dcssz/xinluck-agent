...
<div class="page-bar">
	...
	<div class="act-group">
		<span>跑馬燈對象</span>&nbsp;
		<select name="select_marquee_target">
			<option value="-1">全部</option>
			<!--slot=1-->
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">前台設定 - 跑馬燈管理</span>
		</div>
        <button class="btn red add-marquee-btn" onclick="add_managee()">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/marquee/manager.js?cache=132" type="text/javascript"></script>
