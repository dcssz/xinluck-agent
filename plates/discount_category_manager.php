...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">優惠管理 - 優惠分類設定</span>
		</div>
        <button class="btn red add-discount-category-btn" onclick="request_editor_item_div('add', '');">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/discount_category/manager.js?cache=151" type="text/javascript"></script>
