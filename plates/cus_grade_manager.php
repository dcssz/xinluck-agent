...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">會員管理 - 等級設定</span>
		</div>
        <button class="btn red add-cus-grade-btn" onclick="request_editor_item_div('add', '');">新增</button>
	</div>

	<div class="portlet-body">
	   <div>
		   <span class="red-txt">※優先度須連續且不重複</span>
	   </div>
...
<![endif]-->
        ...
        <script src="/templates/js/cus_grade/manager.js?cache=132" type="text/javascript"></script>
