...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">遊戲管理 - 遊戲標籤設定</span>
		</div>
        <button class="btn red add-game-mark-btn" onclick="request_editor_item_div('add', '');">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/game_mark/manager.js?cache=103" type="text/javascript"></script>
