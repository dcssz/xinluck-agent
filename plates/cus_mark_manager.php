...
#editor-item-div, #extra-func-div{
	padding:  10px;
}
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">會員管理 - 標籤設定</span>
		</div>
        <button class="btn red add-cus-mark-btn" onclick="request_editor_item_div('add', '');">新增</button>
	</div>
...
<div id="extra-func-div" style="display: none;">
...
<![endif]-->
        ...
        <script src="/templates/js/cus_mark/manager.js?cache=152" type="text/javascript"></script>
<script src="cxColor/js/jquery.cxcolor.js?cache=4" type="text/javascript"></script>
