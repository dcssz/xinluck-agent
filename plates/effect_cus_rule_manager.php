...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">代理管理 - 有效會員規則設定</span>
		</div>
        <button class="btn red add-effect-cus-rule-btn" onclick="request_editor_item_div('add', '');">新增</button>
	</div>
    ...
    <input type="hidden" id="edit-unique-code" name="edit-unique-code" value="3" />
</div>
...
<![endif]-->
        ...
        <script src="/templates/js/effect_cus_rule/manager.js?cache=132" type="text/javascript"></script>
