...
<div class="page-bar">
	...
	<div class="act-group">
		<span>公告對象</span>&nbsp;
		<select name="select_news_target">
			<option value="-1">全部</option>
			<!--slot=1-->
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">前台設定 - 公告管理</span>
		</div>
        <button class="btn red add-news-type-btn" onclick="add_news()">新增</button>
	</div>
...
<script src="/templates/js/news/manager.js?cache=133" type="text/javascript"></script>
