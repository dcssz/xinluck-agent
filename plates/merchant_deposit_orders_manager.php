...
#payment-content-div .payment-content-tb td{
	padding:8px 10px;
	border:1px solid #ccc;
	text-align: left;
}
#payment-content-div .payment-content-tb td.title{
	background-color: #444;
	color:#fff;
	font-weight:bold;
	text-align: center;
...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="merchant_deposit_orders_manager.php">
	<div class="page-bar">
		...
		<div class="act-group">
			<div class="date-div">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-start-time" name="search_start_time" value="20:20:13" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-end-time" name="search_end_time" value="20:20:13" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
							<i class="fa fa-clock-o"></i>
						</button>
	...
	<option  value="1" > 未入款</option>

	<option  value="2" > 取消</option>

	<option  value="100" > 已入款</option>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流管理 - 三方入款審核</span>
		</div>
        <div class="timer-bar">
...
<div id="payment-content-div" style="display: none;">
...
<![endif]-->
        ...
        <script src="/templates/js/merchant_deposit_orders/manager.js?cache=127" type="text/javascript"></script>
