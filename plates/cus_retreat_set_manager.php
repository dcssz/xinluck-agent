...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">優惠管理 - 退水優惠設定</span>
            &nbsp;&nbsp;<span class="red-txt">退水週期設置:</span>
            <select id="retreat-times-type" onchange="change_retreat_set();">
            	<option value="1" selected>每日</option>
                <option value="2" >每月</option>
                <option value="3" >每周</option>
			</select>
            &nbsp;&nbsp;<span class="red-txt">退水發放方式:</span>
            <select id="retreat-is-auto" onchange="change_retreat_set();">
            	<option value="1" selected>自動發放</option>
                <option value="2" >手動發放</option>
                <option value="3" >自動發放並自動領取</option>
			</select>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/cus_retreat_set/manager.js?cache=141" type="text/javascript"></script>
