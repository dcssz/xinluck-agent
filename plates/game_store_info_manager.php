...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">遊戲管理 - 廠商設定</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/game_store_info/manager.js?cache=155" type="text/javascript"></script>
