...
<div class="page-inner-content">
	<!--slot=0-->
<style>
#ea_form table th, #ea_form table td{
	padding: 5px;
}
.hidden{
...
<div>
    <form name="ea_form" id="ea_form">
      <input type="hidden" name="paction" value="updateAll" >
        <table>
            <tr>
              <th>帳號:</th>
              <th><input class="customer_userid"  type="text"  name="customer_userid" value="<?=$agent->username?>" <?=$etype=='edit'?'disabled':''?> /></th>
            </tr>
            <tr class="<?=$etype=='edit'?'hidden':''?>">
              <th>密碼:</th>
              <th><input name="customer_pass" type="text"   value="" /></th>
            </tr>
            <tr>
              <th>名稱:</th>
              <th><input name="customer_name" type="text"   value="<?=$agent->nickname?>" /></th>
            </tr>
            <tr class="hidden">
              <th>權限:</th>
              <th></th>
            ...
            <tr>
              <td colspan="100%" align="right"><input type='button' value='送出' onclick="add_action();" /></td>      
            </tr>
        </table>
    </form>
    <input type="hidden" id="etype" value="<?=$etype?>">
    <input type="hidden" id="edit-cus-id" value="<?=$agent->id?>">
</div>
...
<![endif]-->
		...
		<script src="/templates/js/kang_common.js?cache=110"></script>
		<script src="/templates/js/kang_all.js?cache=203"></script>
		<script src="/templates/js/lang/tw.js?cache=203"></script>
        <script src="/templates/js/sub_customer/editor.js?cache=106" type="text/javascript"></script>
