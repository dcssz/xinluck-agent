...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">優惠管理 - 優惠派發審核</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/cus_discount_audit/manager.js?cache=144" type="text/javascript"></script>
