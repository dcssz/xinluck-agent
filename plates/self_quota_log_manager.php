...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">資金明細報表</span>
...
<![endif]-->
        ...
        <script src="/templates/js/self_quota_log/manager.js?cache=109" type="text/javascript"></script>
