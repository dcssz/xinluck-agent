...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流設定 - 公司入款設定</span>
		</div>
		<button class="btn red add-payment-company-btn" onclick="add_payment_company()">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/payment_company/manager.js?cache=104" type="text/javascript"></script>
