...
.bank-ver-status-btn.s2{
	color: #FFF;
    background-color: goldenrod;
}
.bank-ver-status-btn.s3{
	color: #FFF;
    background-color: mediumpurple;
}
.bank-ver-status-btn.s100{
	color: #FFF;
...
#bank-ver-div .bank-ver-tb .no-data{
	color:red;
}
#bank-ver-div .bank-ver-tb .bank-img{
	max-width: 200px;
}
...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="cus_bank_info_manager.php">
	<div class="page-bar" id="search-data-area">
		<div class="panel">
			...
			<div class="act-group">
				<span>驗證狀態</span>&nbsp;
				<select name="search_bank_ver_status">
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">會員管理 - 會員銀行卡審核</span>
		</div>
	</div>
...
<div id="bank-ver-div" style="display: none;">
...
<![endif]-->
        ...
        <script src="/templates/js/cus_bank_info/manager.js?cache=149" type="text/javascript"></script>
