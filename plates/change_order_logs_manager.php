...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">報表管理 - 改帳通知</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/change_order_logs/manager.js?cache=123" type="text/javascript"></script>
