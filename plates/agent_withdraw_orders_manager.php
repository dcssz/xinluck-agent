...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="agent_withdraw_orders_manager.php">
	<div class="page-bar">
		...
		<div class="act-group">
			<div class="date-div">
				<div>申請時間</div>&nbsp;
				<div class="input-group input-small date date-picker sddate" data-date="2021-10-19" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
					<input type="text" class="form-control" id="search-start-date" name="search_start_date" value="2021-10-19" readonly>
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-start-time" name="search_start_time" value="10:32:50" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
				...
				<div class="sign">~</div>
				<div class="input-group input-small date date-picker eddate" data-date="2021-11-02" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
					<input type="text" class="form-control" id="search-end-date" name="search_end_date" value="2021-11-02" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
						<i class="fa fa-calendar"></i>
						</button>
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-end-time" name="search_end_time" value="10:32:50" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
							<i class="fa fa-clock-o"></i>
						</button>
	...
	<div class="search-detail-div">
		<div class="detail-bar date-pick-div">
			<span>快選日期</span>&nbsp;
			<button type="button" class="btn red btn_yesterday btn-md" today-date="2021-10-26">昨日</button>
			<button type="button" class="btn red btn_today btn-md" today-date="2021-10-26">今日</button>
			<button type="button" class="btn red btn_lastweek btn-md" today-date="2021-10-26">上週</button>	
			<button type="button" class="btn red btn_thisweek btn-md" today-date="2021-10-26">本周</button>
			<button type="button" class="btn red btn_lastmonth btn-md" today-date="2021-10-26">上月</button>
			<button type="button" class="btn red btn_thismonth btn-md" today-date="2021-10-26">本月</button>
		</div>
...
<![endif]-->
        ...
        <script src="/templates/js/agent_withdraw_orders/manager.js?cache=111" type="text/javascript"></script>
