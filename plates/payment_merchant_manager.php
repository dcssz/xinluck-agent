...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流設定 - 在線商戶設定</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/payment_merchant/manager.js?cache=102" type="text/javascript"></script>
