...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="agent_report_manager.php">
	<div class="page-bar">
	...
	<input type="hidden" name="ckout_item" id="ckout-item" value="1">
</form>
<div id="ckout-items-btn-area">
	<a class="ckout-items-btn active" href="agent_report_manager?ckout_item=1" ckout-item="1">代理佣金明細</a>
    <a class="ckout-items-btn " href="agent_report_manager?ckout_item=2" ckout-item="2">代理退水明細</a>
    <a class="ckout-items-btn " href="agent_report_manager?ckout_item=3" ckout-item="3">總代理總輸贏明細</a>
</div>
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-group font-green-sharp"></i>
			<span class="caption-subject font-green-sharp bold uppercase">報表管理 - 代理數據報表</span>
			...
			<table class="table table-striped table-bordered table-hover order-column">
				<thead>
					<tr class="bg-green1 color-white">
						<th>期數名稱</th><th>累計盈利額度</th><th>當前盈利額度</th><th>派發佣金</th><th>審核時間</th>
					</tr>
				</thead>
				<tbody>
					<tr><td class="red-txt text-center" colspan="100%">查無資訊!</td></tr>
				</tbody>
			 </table>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/agent_report/manager.js?cache=119" type="text/javascript"></script>
