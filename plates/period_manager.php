...
<div class="page-bar">
	<div class="act-group">
		<span>期數名稱</span>&nbsp;
		<input type="text" name="search_period_name" value="">
    </div>
	<div class="act-group">
		<span>結轉類型</span>&nbsp;
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">代理管理 - 期數設定</span>
		</div>
        <button class="btn red add-period-btn" onclick="add_period()">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/period/manager.js?cache=130" type="text/javascript"></script>
