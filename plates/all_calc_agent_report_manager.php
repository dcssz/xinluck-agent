...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="all_calc_agent_report_manager">
	<div class="page-bar">
...
<div id="ckout-items-btn-area">
    ...
    <a class="ckout-items-btn active" href="all_calc_agent_report_manager">代理報表</a>
</div>
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-group font-green-sharp"></i>
			<span class="caption-subject font-green-sharp bold uppercase">報表管理 - 代理報表</span>
		  ...
		  <table class="table table-striped table-bordered table-hover list-table"> 
		   <thead> 
			<tr class="bg-green1 color-white"> 
			 ...
			 <th class="cus-lev14-commission hidden">佣金規則</th>
			 <th class="cus-lev14-commission hidden">總輸贏規則</th>
			 <th>廠商上繳</th>
			 <th>總計</th> 
			</tr> 
		   </thead> 
		   <tbody> 
			<tr> 
			 <td class="text-left" colspan="2">總計</td> 
			 ...
			 <td class=" cus-lev14-retreat hidden">0</td>
			 <td class=""><?=$allTotal->totalWinlose?></td>
			...
			<tr>
			 ...
			 <td class=""><?=$user->totalNetAmount?></td>
			 <td class="">0</td>
			 <td class="">0</td>
			 <td class="cus-lev14-commission hidden">0</td>
			 <td class="cus-lev14-commission hidden">0</td>
