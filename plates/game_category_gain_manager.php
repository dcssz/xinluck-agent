...
.gc-name-setting-table{
	width: 100%;
}
.gc-name-setting-table th{
	background-color: #39a8a9;
	color: #FFF;
}
.gc-name-setting-table th, .gc-name-setting-table td{
...
#gs-btn-area .gs-btn.active{
	background-color:#337ab7;
	color:#FFF;
}
</style>
<div class="page-bar" id="gs-btn-area">
	<a class="gs-btn active" href="game_category_gain_manager?game_store=26">皇家電子</a><a class="gs-btn " href="game_category_gain_manager?game_store=32">BNG電子</a>
</div>
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-group font-green-sharp"></i>
			<span class="caption-subject font-green-sharp bold uppercase">遊戲管理 - 遊戲新增及語系設定</span>
		</div>
		<button class="btn btn-danger event-btn" onclick="save_info();">儲存</button>
		
		<button class="btn btn-success event-btn" onclick="get_gstore_gc_info();">獲取最新遊戲</button>
	</div>
    
	<div class="portlet-body">
		<form id="gc-name-setting-form">
		   <table class="gc-name-setting-table">
				<tr>
					<th>遊戲中文名稱</th>
					<th>遊戲簡體名稱</th>
					<th>遊戲英文名稱</th>
...
<input type="hidden" id="edit-game-store" value="26" />
...
<![endif]-->
        ...
        <script src="/templates/js/game_category_gain/manager.js?cache=126" type="text/javascript"></script>
