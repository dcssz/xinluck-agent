...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="company_deposit_orders_manager.php">
	<div class="page-bar">
		...
		<div class="act-group">
			<div class="date-div">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-start-time" name="search_start_time" value="20:20:56" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-end-time" name="search_end_time" value="20:20:56" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
							<i class="fa fa-clock-o"></i>
						</button>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流管理 - 公司入款審核</span>
		</div>
        <div class="timer-bar">
...
<![endif]-->
        ...
        <script src="/templates/js/company_deposit_orders/manager.js?cache=113" type="text/javascript"></script>
