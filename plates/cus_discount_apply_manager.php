...
#add-item-div, #editor-item-div, #get-discount-div{
	padding:  10px;
}
.nowrap{
	white-space: nowrap;
...
#audit-log-div .audit-log-tb tr.title{
	background-color: #444;
	color:#fff;
	font-weight:bold;
}
#audit-log-div .audit-log-tb td{
	padding:8px 10px;
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">優惠管理 - 會員申請優惠審核</span>
		</div>
        <button class="btn red add-item-btn" onclick="request_add_item_div('add', '');">新增</button>
	</div>
...
<div id="add-item-div" style="display: none;">
	
</div>
<div id="editor-item-div" style="display: none;">
	
</div>
<div id="audit-log-div" style="display: none;">
	
</div>
<div id="get-discount-div" style="display: none;">
...
<![endif]-->
        ...
        <script src="/templates/js/cus_discount_apply/manager.js?cache=153" type="text/javascript"></script>
