...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流設定 - 支付渠道設定</span>
		</div>
        <button class="btn red add-payment-pattern-btn hidden" onclick="request_editor_item_div('add', '');">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/payment_pattern/manager.js?cache=148" type="text/javascript"></script>
