...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">系統管理 - 後台帳號權限管理</span>
		</div>
		<button class="btn red add-employee-btn" onclick="add_employee()">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/employee/manager.js?cache=3" type="text/javascript"></script>
