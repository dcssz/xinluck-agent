...
<div class="page-bar">
	...
	<div class="act-group">
		<span>登入IP</span>&nbsp;
		<input type="text" size="8" name="search_login_ip" value="">
    </div>
    <div class="act-group">
		<span>狀態</span>&nbsp;
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">系統管理 - IP管理</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/cus_ip/manager.js?cache=129" type="text/javascript"></script>
