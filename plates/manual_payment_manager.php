...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="manual_payment_manager.php">
	<div class="page-bar">
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">金流管理 - 人工出入金</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/manual_payment/manager.js?cache=154" type="text/javascript"></script>
