...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">前台設定 - 輪播圖管理</span>
		</div>
        <button class="btn red add-banner-btn" onclick="add_banner()">新增</button>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/banner/manager.js?cache=102" type="text/javascript"></script>
