...
.sys-service-setting-table{
	width: 100%;
}
.sys-service-setting-table th{
	background-color: #39a8a9;
	color: #FFF;
}
.sys-service-setting-table th, .sys-service-setting-table td{
	border: 1px solid #ccc;
	text-align: center;
	padding: 10px 0px;
}
.sys-service-setting-table .notice-txt{
	color: red;
}
</style>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">系統管理 - 客服設定</span>
		</div>
		<button class="btn btn-danger event-btn" onclick="save_info()">儲存</button>
	</div>

	<div class="portlet-body">
		<form id="sys-service-setting-form">
			<div class="pd-5">
            	<span>Line加入好友連結</span>&nbsp;&nbsp;<span><input type="text" size="24" name="config_content[line_link]" value="<?=e($svs_service->value)?>"></span>
			</div>
...
<![endif]-->
        ...
        <script src="/templates/js/sys_service_set/manager.js?cache=124" type="text/javascript"></script>
