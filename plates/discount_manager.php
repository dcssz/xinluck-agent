...
#pattern-btn-area .pattern-btn.active{
	background-color:#337ab7;
	color:#FFF;
}
</style>
<div class="page-bar" id="pattern-btn-area">
	<a class="pattern-btn active" href="discount_manager?discount_pattern=-1">當前優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=2">每日首存</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=4">充值優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=5">註冊優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=6">首存優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=7">升級優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=8">推薦優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=9">會員申請優惠</a>
    <a class="pattern-btn " href="discount_manager?discount_pattern=1">自定義</a>
</div>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">優惠管理 - 優惠設定</span>
		</div>
        <button class="btn red add-discount-btn hidden" onclick="add_discount()">新增</button>
	</div>
...
<input type="hidden" value="-1" id="discount-pattern">
...
<![endif]-->
        ...
        <script src="/templates/js/discount/manager.js?cache=125" type="text/javascript"></script>
