...
<form id="report-form" class="form-horizontal" role="form" method="GET" action="agent_quota_log_manager.php">
	<div class="page-bar">
		...
		<div class="act-group">
			<div class="date-div">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-start-time" name="search_start_time" value="20:33:01" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
				...
				<div class="input-group input-small search-time">
					<input type="text" id="search-end-time" name="search_end_time" value="20:33:01" class="form-control timepicker timepicker-24" readonly>
					<span class="input-group-btn">
						<button class="btn blue" type="button">
							<i class="fa fa-clock-o"></i>
						</button>
	...
	<option  value="7" > 佣金派發</option>

	<option  value="8" > 總輸贏派發</option>

	<option  value="9" > 佔水派發</option>

	<option  value="10" > 金流手續費</option>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">報表管理 - 代理資金明細報表</span>
		</div>
	</div>
...
<![endif]-->
        ...
        <script src="/templates/js/agent_quota_log/manager.js?cache=108" type="text/javascript"></script>
