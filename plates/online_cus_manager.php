...
<div class="portlet light bordered">
    <div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">會員管理 - 在線會員查詢</span>
		</div>
        <div class="timer-bar">
...
<![endif]-->
        ...
        <script src="/templates/js/online_cus/manager.js?cache=129" type="text/javascript"></script>
