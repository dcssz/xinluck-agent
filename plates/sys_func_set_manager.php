...
.sys-func-setting-table{
	width: 100%;
}
.sys-func-setting-table th{
	background-color: #39a8a9;
	color: #FFF;
}
.sys-func-setting-table th, .sys-func-setting-table td{
	border: 1px solid #ccc;
	text-align: center;
	padding: 10px 0px;
}
.sys-func-setting-table .notice-txt{
	color: red;
}
</style>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">系統管理 - 功能設定</span>
		</div>
		<button class="btn btn-danger event-btn" onclick="save_info()">儲存</button>
	</div>
    
	<div class="portlet-body">
		<form id="sys-func-setting-form">
		   <table class="sys-func-setting-table">
				<tr>
					<th>功能名稱</th>
					<th>是否啟用</th>
				</tr>
				<tr><td>充值是否需身份驗證</td><td><input type="checkbox" name="config_content[deposit_need_identity_verify]" value="1" ></td></tr><tr><td>充值是否需綁定銀行卡</td><td><input type="checkbox" name="config_content[deposit_need_bank_verify]" value="1" ></td></tr><tr><td>取款是否需身份驗證</td><td><input type="checkbox" name="config_content[withdraw_need_identity_verify]" value="1" ></td></tr><tr><td>強制使用自動轉入遊戲平台功能<div class="notice-txt">(如開啟，會員將無法自行於轉點平台開關此功能，且無法單獨針對某遊戲平台手動進行點數轉入轉出，只可觀看餘額以及手動執行全部遊戲平台點數一次轉回主帳戶之功能)</div></td><td><input type="checkbox" name="config_content[enforce_autopay]" value="1" checked></td></tr><tr><td>是否顯示資金紀錄</td><td><input type="checkbox" name="config_content[is_show_cus_quota_log]" value="1" ></td></tr><tr><td>被推薦會員可被計算退水規則給介紹人的上線代理</td><td><input type="checkbox" name="config_content[invitee_can_retreat_rule]" value="1" ></td></tr><tr><td>被推薦會員可被計算佣金規則給介紹人的上線代理</td><td><input type="checkbox" name="config_content[invitee_can_commission_rule]" value="1" ></td></tr><tr><td>被推薦會員可被計算總輸贏規則給介紹人的上線代理</td><td><input type="checkbox" name="config_content[invitee_can_extra_commission_rule]" value="1" ></td></tr>
                <tr class="extra-config-content">
                	<td>
                    	<div>設定分享賺錢-複製文字內容</div>
                        <div class="red-txt">(前台顯示會在文字內容下方，自動帶入會員邀請連結)</div>
                        <textarea class="copy-textarea" name="config_content[share_invite_content]" rows="5", cols="35"></textarea>
                    </td>
                    <td>
                    </td>
                </tr>
...
<![endif]-->
        ...
        <script src="/templates/js/sys_func_set/manager.js?cache=124" type="text/javascript"></script>
