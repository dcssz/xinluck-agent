...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp bold uppercase">代理管理 - 總代理設定</span>
		</div>
...
<input type="hidden" id="edit-cus-level" name="edit_cus_level" value="14">
...
<![endif]-->
	...
	<script>
		function show(id) {
			// 先發送 AJAX 請求獲取會員資訊
			$.ajax({
				url: '/admin/get_agent_info',  // 請根據實際的API路徑調整
				type: 'POST',
				data: {
					id: id
				},
		...
		function handleFundAdjustment(layero, index, id) {
			...
			// 發送資金調度請求
			$.ajax({
				url: '/admin/agent_adjust_funds',  // 請根據實際的API路徑調整
				type: 'POST',
				data: data,
				dataType: 'json',
				success: function(response) {
