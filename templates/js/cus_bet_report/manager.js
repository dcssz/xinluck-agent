...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		//location.href = "cus_bet_info_manager.php?sddate=" + sddate + "&eddate=" + eddate + "&search_date_type=" + search_date_type + "&search_customer_userid=" + search_customer_userid + "&search_level=" + search_level + "&search_game_store=" + search_game_store + "&search_game_category=" + search_game_category + "&search_is_finished=" + search_is_finished + "&search_order_no=" + search_order_no + "&page_now=" + page_now;
		// $('#report-form').submit();
		param = $("#search-data-area [is-search-data=1]").serialize();
		$table.bootstrapTable('refresh', {url: "/agent/cus_bet_report_op?" + param});
	});
});
