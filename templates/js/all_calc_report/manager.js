...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		//location.href = "all_calc_report_manager.php?sddate=" + sddate + "&eddate=" + eddate + "&search_date_type=" + search_date_type + "&search_customer_userid=" + search_customer_userid + "&search_level=" + search_level;
		$('#report-form').submit();
	});
});
