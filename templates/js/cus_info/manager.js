        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
				   ...
				   "url": "/op/cus_info_manager_op.php?pdisplay=display_manager_list&" + $("#search-data-area [is-search-data=1]").serialize() + "&edit_cus_level=" + $("#edit-cus-level").val() + "&top_cus_id=" + $("#top-cus-id").val() + "&edit_station_code=" + $("#edit-station-code").val(), 
                },
				 "bSort": false,
                /*"order": [
                    [1, "asc"]
...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		grid.getDataTable().ajax.url("/op/cus_info_manager_op.php?pdisplay=display_manager_list&" + param).load();
...
function add_cus(){
	...
	location.href = "cus_info_editor.php?etype=add&edit_cus_level=" + edit_cus_level + "&edit_station_code=" + edit_station_code + "&top_cus_id=" + top_cus_id;
}
...
function request_identity_ver_div(edit_cus_id){
	requestJSON("cus_info_manager_op.php", "pdisplay=request_identity_ver_div", "edit_cus_id=" + edit_cus_id);
}
...
function save_identity_ver(){
	...
	requestJSON("cus_info_manager_op.php", "pdisplay=save_identity_ver", post_ele);
}
