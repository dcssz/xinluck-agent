...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		var game_store_arr = $("#game-ckbox-inner [is-post-data=1]").serialize();*/
		layer.open({
			title: false,
		...
		//location.href = "game_report_manager.php?sddate=" + sddate + "&eddate=" + eddate + "&search_date_type=" + search_date_type + "&search_customer_userid=" + search_customer_userid + "&search_level=" + search_level + "&" + game_store_arr;
		$('#report-form').submit();
	});
});
