...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		var search_order_by = $("select[name=search_order_by]").val();
		var search_order_by_field = $("select[name=search_order_by_field]").val()*/
		...
		//location.href = "cus_report_manager.php?sddate=" + sddate + "&eddate=" + eddate + "&search_date_type=" + search_date_type + "&search_customer_userid=" + search_customer_userid + "&search_level=" + search_level + "&search_order_by=" + search_order_by + "&search_order_by_field=" + search_order_by_field;
		$('#report-form').submit();
	});
});
