...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		var ckout_item = $('.ckout-items-btn.active').attr("ckout-item");
		...
		//location.href = "agent_report_manager.php?sddate=" + sddate + "&eddate=" + eddate + "&ckout_item=" + ckout_item + "&search_customer_userid=" + search_customer_userid;
		$('#report-form').submit();
	});
});
