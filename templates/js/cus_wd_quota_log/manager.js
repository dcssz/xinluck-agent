...
$(function(){
	...
	$(".search-btn").click(function(){
		...
		var search_trans_type = $("select[name=search_trans_type]").val()
		...
		//location.href = "cus_wd_quota_log_manager.php?type=" + type + "&sddate=" + sddate + "&eddate=" + eddate + "&search_customer_userid=" + search_customer_userid + "&search_level=" + search_level + "&fuzzy_search=" + ($("input[name=fuzzy_search]").prop("checked") ? "1" : "0") + "&search_trans_type=" + search_trans_type + "&page_now=" + page_now;
		$('#report-form').submit();
	});
});
