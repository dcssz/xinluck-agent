    ...
    var handleRecords = function () {
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "/op/change_order_logs_op.php?pdisplay=display_manager_list", // ajax source
                },
				 "bSort": false,
                /*"order": [
                    [1, "asc"]
...
function change_status(edit_log_id){
	if(confirm(change_lang_txt({"org_txt" : "確定要處理"}) + "?")){
		requestJSON("change_order_logs_op.php", "pdisplay=change_status", "edit_log_id=" + edit_log_id);
	}
}
